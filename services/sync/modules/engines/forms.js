...
let FormWrapper = {
  ...
  getAllEntries: function getAllEntries() {
    ...
    let query = Svc.Form.DBConnection.createAsyncStatement(
      ...
      "LIMIT 500");
    return Async.querySynchronously(query, ["name", "value"]);
  },
  ...
  getEntry: function getEntry(guid) {
    ...
    return Async.querySynchronously(query, ["name", "value"])[0];
  },
  ...
  getGUID: function getGUID(name, value) {
    ...
    let item = Async.querySynchronously(getQuery, ["guid"])[0];
    ...
    Async.querySynchronously(setQuery);
  ...
  hasGUID: function hasGUID(guid) {
    ...
    query.params.guid = guid;
    return Async.querySynchronously(query, ["guid"]).length == 1;
  },
  ...
  replaceGUID: function replaceGUID(oldGUID, newGUID) {
    ...
    Async.querySynchronously(query);
  }
